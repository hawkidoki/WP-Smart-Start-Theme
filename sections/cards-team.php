    ...
    <?php $i=0; while($section['result']->have_posts()): $section['result']->the_post(); $i++; ?>
        <div class="team-member one-fourth <?php echo ($i%4 == 0) ? 'last': ''; ?>">
            ...
            <div class="content">
                ...
                <?php if(isset($post->wpsst_team_meta['job_title'])){ ?>
                    <span class="job-title"><?php echo $post->wpsst_team_meta['job_title']; ?></span>
                <?php } ?>
            ...
            <?php if(isset($post->wpsst_team_meta['social'])){ ?>
                <ul class="social-links">
                    <?php foreach($post->wpsst_team_meta['social'] as $meta){ ?>
