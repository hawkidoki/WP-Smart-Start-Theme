...
jQuery(document).ready(function($) {
	...
	(function() {
		...
		if( $map.length ) {
            ...
            var wpsst_marker_address = '2 Elizabeth St, Melbourne Victoria 3000 Australia';
            if(typeof wpsst_marker !== 'undefined')
                wpsst_marker_address = wpsst_marker;

			$map.gMap({
				address: 'Level 13, ' + wpsst_marker_address,
				zoom: 13,
				markers: [
					{ 'address' : 'Level 13, ' + wpsst_marker_address }
				]
